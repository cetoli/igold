...
class DataSource:
    ...
    def get_file_contents(self, packager, project='guarani', moduler="main.py"):
    ...
    def update_file(self, decoded_content, packager, project='guarani', moduler="main.py", comment=None):
    ...
    def get_branches(self, project='guarani'):
        self.repo = self.user.get_repo(project)
