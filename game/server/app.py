...
root_path = os.path.realpath(os.path.join(os.path.dirname(os.path.realpath(__file__)), os.pardir))
vit = os.path.realpath(os.path.join(root_path, "vitollino"))
...
'''
@app.get("/_codex/{filepath}")
def py_code(filepath):
    """Serve static index page.
    """
    python_code = os.path.join(root_path, filepath)
    print("python_code", python_code)
    ...
    return FileResponse(python_code)
'''
